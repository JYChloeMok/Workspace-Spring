...
<!-- jsp도 템플릿 등록 가능! 기본으로 불러와지는 New JSP File (html 5)에 추가 -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<c:if test="${not empty alertMsg }">
		<script>
			alertify.alert("성공", "${alertMsg}", function() { alertify.success("힝잉잉")});
		</script>
            ...
            <div id="header_1_right">
            	<c:choose>
            		<c:when test="${ empty loginUser }">
						...
						<!-- 모달의 원리 : 이 버튼 클릭시 data-targer에 있는 해당 아이디 div요소를 띄움 -->
    ...
    <!-- 로그인 클릭 시 뜨는 모달 (기존에는 안보이는 상태로 존재하다가 버튼 클릭 시 보임) -->
